...
class FinancialService:
    ...
    def calculate_monthly_fees_functional(units: List[Unit],
        ...
        """
        Calcul des frais mensuels pour les unités.
        ...
        Returns:
            List[FinancialRecord]: Enregistrements financiers
        """
    ...
    def _get_calculation_function(method: FeeCalculationMethod) -> Callable[[Unit], Tuple[Decimal, Dict[str, Decimal]]]:
        """
        Factory de fonctions de calcul.

        Returns:
            Fonction de calcul selon la méthode choisie
        """
        calculation_methods = {
    ...
    def calculate_monthly_fees(unit: Unit) -> Decimal:
        """
        Calcul simple des frais mensuels.
