...
def main():
    ...
    summary_logger.info("SOMMAIRE FINAL - TESTS D'ACCEPTANCE")
    summary_logger.info("=" * 60)
    ...
    if all_passed:
        summary_logger.info(f"RÉSULTAT: {status_text} - Tous les tests d'acceptance passent")
    else:
    ...
    if all_passed:
        summary_logger.info("STATUT FINAL: TESTS D'ACCEPTANCE RÉUSSIS")
    else:
        summary_logger.error("STATUT FINAL: TESTS D'ACCEPTANCE ÉCHOUÉS")
