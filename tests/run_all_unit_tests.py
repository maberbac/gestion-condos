...
def main():
    ...
    logger.info("=" * 60)
    logger.info("SOMMAIRE FINAL - TESTS UNITAIRES")
    logger.info("=" * 60)
    ...
    if all_passed:
        logger.info(f"RÉSULTAT: {status_text} - Tous les tests unitaires passent")
    else:
    ...
    if all_passed:
        logger.info("STATUT FINAL: TESTS UNITAIRES RÉUSSIS")
    else:
        logger.error("STATUT FINAL: TESTS UNITAIRES ÉCHOUÉS")
